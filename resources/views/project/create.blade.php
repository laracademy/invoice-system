...
@section('content')
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="card">
                <div class="header">
                    <h4 class="title">Creating New Project</h4>
                    <p class="category">Fill in the fields to create a new project</p>
                </div>
                ...
                <div class="content">
                    ...
                    <form action="{{ route('project.store') }}" method="POST" autocomplete="off">
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-success btn-block btn-lg" value="Create Project">
                        </div>
                    </form>
                </div>
            </div>
